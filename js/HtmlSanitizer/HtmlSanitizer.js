...
var HtmlSanitizer = new (function () {
	...
	var attributeWhitelist_ = {
		'class': true, 'align': true, 'color': true, 'controls': true, 'height': true, 'href': true, 'src': true, 'style': true, 'target': true, 'title': true,
		'type': true, 'width': true, 'frameborder': true, 'allow': true, 'allowfullscreen': true, 'autoplay': true, 'loop': true, 'muted': true
	};
